...
本项目第一阶段目标不是构建完整企业级客服平台，而是先实现一个可运行、可演示、可扩展的通用 AI 客服基础版，后续再逐步扩展为企业主力客服系统。
...
优先先完成阶段 1-3：让系统能聊天、能上传文档、能基于企业知识库完成 RAG 问答、能展示引用来源、能在无依据时拒答。阶段 3 完成后，项目就已经具备 GitHub、简历和面试展示价值。

阶段 4-6 用于把项目从“技术 Demo”逐步打磨成“产品型作品”：补充聊天记录、反馈、知识缺口、转人工入口、管理后台，以及订单 / 工单 Mock API 等企业系统集成模拟能力。
